...
public class RealtimePredict {
    ...
    public static void main(String[] args) {
       String[] arrVal="ml-Tt58EAnBUjp,textVar=s3://aml-sample-data/banking.csv,numericVar=123".split(",");
        String mlModelId = arrVal[0];
        
        RealtimePredict rtp = new RealtimePredict(mlModelId);
        Map<String,String> record = rtp.parseArgs(arrVal);
